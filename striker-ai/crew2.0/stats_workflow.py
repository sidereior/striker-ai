...
match_stats_finder = Agent(
    ...
    goal = 'Using this info: KJ,Bolden,Football. Look up information on the matches that the player has played for and find specific stats relevant to them and recursively search based upon your search results until you have a comprehensive list of stats',
...
crew = Crew(
  ...
  agents=[ master_searcher, master_report_gen, team_stats_finder, stats_category_manager, match_stats_finder],
